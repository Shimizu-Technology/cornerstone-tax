              ...
              <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    If you don&rsquo;t have copies of your prior year tax returns, you&rsquo;ll need to complete <strong className="text-gray-800">Guam Form 2848 (Power of Attorney)</strong> so our office can request your records from the Department of Revenue and Taxation.
                  </p>
                </div>
                <Link
                  to="/form-2848"
                  className="bg-primary text-white px-6 py-3.5 rounded-xl text-base font-medium hover:bg-primary-dark transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 min-h-[48px] flex items-center gap-2 whitespace-nowrap flex-shrink-0"
                >
                  Learn More

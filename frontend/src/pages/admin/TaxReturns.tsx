    ...
    <div className="space-y-8">
      ...
      <FadeUp>
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight">Tax Returns</h1>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 border border-secondary-dark rounded-xl focus:ring-2 focus:ring-primary focus:border-primary bg-secondary/30 transition-colors"
                />
              </div>
            </div>
      ...
      {/* Returns Table */}
      <FadeUp delay={0.1}>
        <div className="bg-white rounded-2xl shadow-sm border border-secondary-dark overflow-hidden hover:shadow-md transition-shadow duration-300">

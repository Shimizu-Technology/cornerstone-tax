    ...
    class IntakeDocumentsController < BaseController
      ...
      def presign
        ...
        unless ALLOWED_CONTENT_TYPES.include?(content_type)
          return render json: { error: "File type not allowed. Accepted types: PDF, JPEG, PNG" }, status: :unprocessable_entity
        end
      ...
      def set_tax_return_from_upload_token
        ...
        render json: { error: "Invalid or expired upload token" }, status: :not_found
      end

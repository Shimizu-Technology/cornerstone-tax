...
3. **Initialize** in app entry point with PostHogProvider

4. **Track page views** for SPA navigation

### Google Analytics (Alternative)

1. Create property at [Google Analytics](https://analytics.google.com)
2. Add tracking script to index.html or use gtag

---

## 9. Performance Considerations

SEO rankings factor in page speed. Quick wins:
...
### Code
- Enable gzip/brotli compression (usually automatic on Netlify/Vercel)
...
### Hosting
- Use CDN (Netlify, Vercel, Cloudflare)
- Enable HTTP/2

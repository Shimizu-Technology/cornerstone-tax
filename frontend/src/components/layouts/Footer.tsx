    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Company Info */}
          <div>
            <div className="mb-4 h-12 w-fit overflow-hidden flex items-center bg-white rounded px-2">
              <img 
                src="/logo.jpeg" 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/intake" className="text-gray-400 hover:text-white text-sm transition-colors">
                  Client Intake Form
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
          <p>© {currentYear} Cornerstone Accounting & Business Services. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )

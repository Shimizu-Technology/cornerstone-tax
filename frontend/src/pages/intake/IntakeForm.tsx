      ...
      <div className="min-h-screen bg-secondary flex flex-col">
        ...
        <main className="flex-1 max-w-2xl mx-auto w-full px-4 py-6 md:py-8">
          <div className="bg-white rounded-2xl shadow-sm p-6 md:p-8">
            ...
            {/* Contact Info - WhatsApp Option */}
            <div className="bg-secondary rounded-xl p-4 mb-6">
              <p className="text-sm text-gray-700 mb-2">
                <strong>Prefer to message us directly?</strong>
              </p>
              <p className="text-xl font-semibold text-gray-900 mb-3">
                (671) 482-8671
              </p>
              <a
                href="https://wa.me/16714828671?text=Hi%2C%20I'm%20interested%20in%20business%20tax%20services.%20I'd%20like%20to%20schedule%20a%20consultation."
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-green-500 text-white px-4 py-2 rounded-lg font-medium hover:bg-green-600 transition-colors text-sm"
              >
